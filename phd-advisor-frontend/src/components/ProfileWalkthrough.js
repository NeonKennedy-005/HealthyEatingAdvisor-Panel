  ...
  return [
    {
      ...
      fields: [
        {
          key: 'knowledge_level',
          label: 'Where are you on healthy eating?',
          type: 'select',
          options: knowledgeLevels.length
            ? knowledgeLevels
            : [
                { value: 'just_starting', label: 'Just starting out' },
                { value: 'some_changes', label: 'Making some changes already' },
                { value: 'experienced', label: 'Experienced / refining habits' },
                { value: 'curious', label: 'Curious / exploring ideas' },
              ],
        },
        {
          key: 'timezone',
    ...
    {
      title: 'Focus & kitchen setup',
      fields: [
        {
          key: 'cyber_role',
          label: 'Your healthy-eating focus',
          type: 'select',
          options: [
            'Clean eating basics',
            'More fruits & vegetables',
            'Superfoods exploration',
            'Enzymes & digestion',
            'Meal prep & recipes',
            'Reading & resources',
            'Overall diet change',
        ...
        },
        {
          ...
          label: 'Where do you mostly eat / cook?',
          type: 'select',
          options: [
            'Home kitchen',
            'Dorm / shared kitchen',
    ...
    },
    {
      ...
      fields: [
        {
          key: 'primary_domains',
          label: 'Foods or areas you care about most (comma-separated)',
          type: 'text',
          placeholder: 'e.g. vegetables, fruit, whole foods, less sugar, superfoods',
        },
        {
          key: 'certifications',
          label: 'Dietary preferences or constraints (comma-separated)',
          type: 'text',
          placeholder: 'e.g. vegetarian, dairy-free, no medical restrictions',
        },
        {
          key: 'tools_stack',
          label: 'Tools you use (comma-separated)',
          type: 'text',
          placeholder: 'e.g. Instant Pot, air fryer, grocery list app, blender',
        },
      ],
    },
    {
      ...
      fields: [
        {
          ...
          label: 'Time / budget / household constraints',
          type: 'text',
          placeholder: 'e.g. 20 minutes dinner, budget-friendly, cooking for family of 3',
        },
        {
          key: 'current_goals',
          label: 'Current goals',
          type: 'textarea',
          placeholder: 'Eat more real food, reduce processed snacks, pack better lunches...',
        },
        {
          key: 'learning_preferences',
          label: 'How you like advice packaged',
          type: 'text',
          placeholder: 'Short checklists, recipes, science explainers, book shortlists...',
        },
        {
          key: 'advisor_notes',
          label: 'About you & food story',
          type: 'textarea',
          placeholder: 'What you currently eat, what feels hard, what success looks like.',
        },
      ],
    },
  ];
