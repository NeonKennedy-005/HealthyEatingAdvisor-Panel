...
const STEPS = [
  ...
  },
  {
    ...
    icon: 'gavel',
    body: 'Reviewer 2, Devil\'s Advocate, and Scope Realism are tuned to push back, not validate. They\'re where your food plan gets sharpened. Add them when you\'re ready for honest feedback.',
  },
];
