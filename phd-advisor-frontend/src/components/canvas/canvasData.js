...
export const INSIGHTS = [
  {
    ...
    updatedMinutesAgo: 5,
    quotes: [
      '"Prioritize 6 tailored apps over 15 spray-and-pray." — Enzyme Explorer',
      '"Add one quantified analytics bullet before the next batch." — Veggie Chef',
    ],
  },
  {
    id: 'i-method',
    ...
    quotes: [
      '"Paste the JD and we will mirror keywords without inventing skills." — Veggie Chef',
      '"Build five STAR stories you can reuse across screens." — Fruit Maven',
    ],
  },
  {
    id: 'i-lit',
    ...
    quotes: [
      '"One personalized alumni note beats ten cold applies." — Kitchen Coach',
      '"Tag every posting: deadline, rolling, or career-fair source." — Superfoods Superman',
    ],
  },
  {
    id: 'i-questions',
    ...
    bullets: [
      '<strong>Q1:</strong> easy vegetable dinners only, or also marketing ops / strategy?',
    ...
    quotes: [
      '"Pick a primary lane for 2 weeks, then expand." — Superfoods Superman',
      '"Protect Tuesday/Thursday 90-minute apply blocks." — Enzyme Explorer',
    ],
  },
  {
    id: 'i-next',
    ...
    updatedMinutesAgo: 9,
    quotes: [
      '"Ship the resume rewrite before opening more tabs." — Veggie Chef',
      '"Schedule interview practice like a class you cannot skip." — Fruit Maven',
    ],
  },
  {
    id: 'i-blockers',
    ...
    quotes: [
      '"Without a weekly system, even a strong resume underperforms." — Enzyme Explorer',
      '"Do not invent metrics — recover real ones from projects and classwork." — Veggie Chef',
    ],
  },
];
