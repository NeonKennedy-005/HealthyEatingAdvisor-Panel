"""
OnboardingAgent — conversational profile gathering for healthy eating advisors.
"""
...
# are themed for the Healthy Eating Advisor panel (Heidi Boudro).
PROFILE_FIELDS: List[tuple] = [
    ("knowledge_level", "Where are you on healthy eating right now?",
     "Just starting, making some changes, experienced, or curious"),
    ("timezone", "What time zone are you usually in?",
     "IANA timezone or region such as America/New_York, Europe/London, UTC"),
    ("cyber_role", "What best describes your healthy-eating focus right now?",
     "Clean eating basics, more produce, superfoods, enzymes, meal prep, books, or overall diet change"),
    ("organization_type", "Where do you mostly eat or cook?",
     "Home kitchen, dorm/shared kitchen, office lunches, on the go, or a mix"),
    ("primary_domains", "Which foods or topics do you care about most?",
     "Comma-separated areas such as vegetables, fruit, whole foods, less sugar, superfoods"),
    ("certifications", "Any dietary preferences or constraints we should respect?",
     "Vegetarian, dairy-free, allergies to avoid discussing, or none"),
    ("tools_stack", "What tools or apps do you use for food?",
     "Blender, Instant Pot, grocery list app, meal tracker, etc."),
    ("compliance_focus", "Any time, budget, or household constraints?",
     "Quick dinners, budget-friendly, cooking for family, limited kitchen access"),
    ("current_goals", "What are you trying to accomplish with food in the next few months?",
     "More real food, fewer processed snacks, better lunches, explore cookbooks, etc."),
    ("learning_preferences", "How do you prefer advice packaged?",
     "Short checklists, recipes, science explainers, book shortlists, or step plans"),
]
